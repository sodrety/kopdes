...
This project is indexed by GitNexus as **kopdes** (3052 symbols, 11793 relationships, 262 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
