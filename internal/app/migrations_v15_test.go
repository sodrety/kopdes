...
func seedLegacyLoanMigrationData(t *testing.T, db *sql.DB) {
	...
	statements := []string{
		...
		`INSERT INTO saving_records (id,member_id,type,category,amount,record_date,reference_no,note,recorded_by) VALUES ('saving-affected','member-affected','deposit','sukarela',50000000,'2026-01-01','SAV-015-A','Migration test capacity','user-affected'),('saving-history','member-history','deposit','sukarela',50000000,'2026-01-01','SAV-015-H','Migration test capacity','user-history')`,
